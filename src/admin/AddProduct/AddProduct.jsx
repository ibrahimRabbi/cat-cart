...
const AddProduct = () => {
    ...
    const productType = ['toy', 'cloth', 'watch', 'shoes', 'pant', 'tshirt', 'moistrue', 'makeup', 'soap', 'bodywash', 'shampoo', 'mobail']
   ...
   const [loading,setLoading] = useState(false)
    ...
    const submitHandler = (data) => {
        setLoading(true)
        const { price, category, productType, description, title, image } = data
    ...
    return (
        <section className='w-[60%] mt-10 mx-auto'>
            <div>
                <h1 className='text-2xl uppercase font-semibold text-center'>Add a New Products</h1>
            </div>
